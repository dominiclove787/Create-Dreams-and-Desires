...
import static uwu.lopyluna.create_dd.item.ItemProperties.sawtool.DeforesterItem.maxUses;


public class DeforesterAxeItem extends AxeItem {
    public DeforesterAxeItem(Tier pTier, float pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
        super(pTier, pAttackDamageModifier, pAttackSpeedModifier, pProperties);
    }
    int getUses = BobTiers.Deforester.getUses();
    @NotNull
    @Override
